"""
JARVIS - Full-Duplex com PyAudio + Pygame + TTS OpenAI
...
TTS_MODEL = "gpt-4o-mini-tts"  # "tts-1" (rápido) ou "tts-1-hd" (alta qualidade)
...
class JarvisFullDuplex:
    ...
    def pensar(self, comando):
        ...
        try:
            resposta = self.cliente.chat.completions.create(
                model=OPENAI_MODEL,
                messages=[
                    {"role": "system", "content": "Você é JARVIS, assistente inteligente, sarcástica e divertida. Responda em português de forma concisa."},
    ...
    def falar(self, texto):
        """Fala texto usando OpenAI TTS + pygame (interruptível a qualquer momento)"""
        ...
        try:
            # 1. Gera áudio usando OpenAI TTS
            print("🎙️ Gerando áudio com OpenAI TTS...")
